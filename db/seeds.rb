...
# 申請前のフロー
1.times do |_n|
  flow = Flow.create(flow_name: 'Draft',
                     creator_key: 1)
  step = flow.steps.create(step_class: Settings.step_class.create)
  step_event = step.step_events.create(step_order: Settings.step_order.create,
                                       step_name: 'Create',
  ...
  step_event = step.step_events.create(step_order: 1,
  ...
  step_event = step.step_events.create(step_order: 2,
                                       step_name: 'Confirm',
                                       step_operator: Settings.step_operator.and,
                                       step_event_class: Settings.step_event_class.create)
  ...
  step = flow.steps.create(step_class: Settings.step_class.approve)
  step_event = step.step_events.create(step_order: 3,
                                       step_name: 'Approve(OR)',
                                       step_operator: Settings.step_operator.or,
                                       step_event_class: Settings.step_event_class.create)
  ...
  step_event = step.step_events.create(step_order: Settings.step_order.archive,
                                       step_name: 'Archive',
                                       step_operator: Settings.step_operator.and,
                                       step_event_class: Settings.step_event_class.create)
...
# 一次承認待ちのフロー
1.times do |_n|
  flow = Flow.create(flow_name: 'Approve(AND)',
                     creator_key: 1)
  step = flow.steps.create(step_class: Settings.step_class.create)
  step_event = step.step_events.create(
    step_order: Settings.step_order.create,
    step_name: 'Create',
    step_operator: Settings.step_operator.and,
    step_event_class: Settings.step_event_class.create
  )
  ...
  person.person_events.create(
    person_event_class: Settings.person_event_class.application
  )
  ...
  person.person_events.create(
    person_event_class: Settings.person_event_class.approve_request
  )
  ...
  step = flow.steps.create(step_class: Settings.step_class.archive)
  step_event = step.step_events.create(
    step_order: Settings.step_order.archive,
    step_name: 'Archive',
    step_operator: Settings.step_operator.and,
    step_event_class: Settings.step_event_class.create
  )
...
# 二次承認待ち（OR）のフロー
1.times do |_n|
  flow = Flow.create(flow_name: 'Approve(OR)',
                     creator_key: 1)
  step = flow.steps.create(step_class: Settings.step_class.create)
  step_event = step.step_events.create(
    step_order: Settings.step_order.create,
  ...
  person = step_event.people.create(person_key: 3)
  person.person_events.create(
    person_event_class: Settings.person_event_class.approve
  )
  ...
  person.person_events.create(
    person_event_class: Settings.person_event_class.confirm_request
  )
  person = step_event.people.create(person_key: 5)
  person.person_events.create(
    person_event_class: Settings.person_event_class.confirm
  )
...
# 完了したフロー
1.times do |_n|
  flow = Flow.create(flow_name: 'Archive',
                     creator_key: 1)
  step = flow.steps.create(step_class: Settings.step_class.create)
  step_event = step.step_events.create(step_order: Settings.step_order.create,
                                       step_name: 'Create',
  ...
  person = step_event.people.create(person_key: 7)
  person.person_events.create(
    person_event_class: Settings.person_event_class.skip
  )
  ...
  person = step_event.people.create(person_key: 1)
  person.person_events.create(
    person_event_class: Settings.person_event_class.archive
  )
end
